...
const out = process.env.NF_OUTPUT_DIR || '/tmp/honey-nights-discovery';
const eventName = process.env.NF_EVENT_NAME || 'Honey Nights';
const theme = process.env.NF_THEME || 'Elegant';
const recipeId = process.env.NF_RECIPE_ID || 'honey-nights';
