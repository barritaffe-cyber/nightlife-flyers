"""Extract supplied Spotlight Gold sheets and package editable UI bitmap lettering.

Run with python3 scripts/build-spotlight-gold-font.py.
...
SOURCE_DIR = ROOT / 'public/generated-flyers/assets/artist:dj'
OUT = ROOT / 'public/generated-flyers/assets/png-glyphs/spotlight-gold'
...
for sheet_index, chars in enumerate(SHEETS, 1):
    path = SOURCE_DIR / f'01glyph{sheet_index:02d}.png'
...
FONT.setupNameTable({'familyName':'Spotlight Gold PNG','styleName':'Regular','uniqueFontIdentifier':'SpotlightGoldPNG-1','fullName':'Spotlight Gold PNG','psName':'SpotlightGoldPNG','version':'Version 1.000'})
...
FONT.font.flavor='woff2';FONT.save(ROOT/'public/fonts/SpotlightGoldPNG.woff2')
(OUT/'metrics.json').write_text(json.dumps({'family':'Spotlight Gold PNG','version':1,'bitmapPpem':PPEM,'sources':SOURCES,'glyphs':REPORT,'kerningPairs':len(pairs)},indent=2)+'\n')
