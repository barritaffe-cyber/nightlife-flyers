...
configs={'bass-blue':('bass','Bass Pressure Blue','BassPressureBluePNG',[])}
...
if key=='bass-blue':
 ...
 cells=[('ABCDEFG',[10,251,477,686,900,1096,1301,1525],25,250,239,189),
 ('HIJKLMN',[20,278,389,577,811,1014,1293,1525],250,458,448,185),
 ('OPQRSTU',[10,244,449,677,886,1088,1300,1525],458,660,646,180),
 ('VWXYZ',[150,400,693,908,1125,1320],660,834,824,154),
 ('0123456789',[20,197,267,421,567,728,881,1028,1182,1340,1525],834,1010,987,147)]
