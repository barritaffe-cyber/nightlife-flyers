"""Extract supplied Rose Chrome Serif sheets and package editable UI bitmap lettering.

Run with python3 scripts/build-rose-chrome-serif-font.py.
...
OUT = ROOT / 'public/generated-flyers/assets/png-glyphs/rose-chrome-serif'
...
for sheet_index, chars in enumerate(SHEETS, 1):
    path = SOURCE_DIR / f'girl-code{sheet_index:02d}.png'
...
FONT.setupNameTable({'familyName':'Rose Chrome Serif PNG','styleName':'Regular','uniqueFontIdentifier':'RoseChromeSerifPNG-1','fullName':'Rose Chrome Serif PNG','psName':'RoseChromeSerifPNG','version':'Version 1.000'})
...
FONT.font.flavor='woff2';FONT.save(ROOT/'public/fonts/RoseChromeSerifPNG.woff2')
(OUT/'metrics.json').write_text(json.dumps({'family':'Rose Chrome Serif PNG','version':1,'bitmapPpem':PPEM,'sources':SOURCES,'glyphs':REPORT,'kerningPairs':len(pairs)},indent=2)+'\n')
