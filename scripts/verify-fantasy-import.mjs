...
try{
 ...
 for(const [id,file] of [['fantasy','fantasy.nflyer']]){
   ...
   for(const format of ['square','story']){
     ...
     if(!process.env.NF_PREVIEW_ONLY)for(const objectId of ["presenter", "presents", "mood", "day", "month", "date", "headline", "subtitle", "genres", "musicLabel", "dj1", "dj2", "dj3", "entry", "entryNote", "dress", "dressNote", "rsvp", "rsvpNote", "time", "venue", "city", "address", "reserve"]){
