...
const out = '/private/tmp/pulse-verification';
...
try{
 for(const format of ['square','story']){
  await page.goto(`http://localhost:3000/generated-flyers/pulse-master.html?format=${format}`,{waitUntil:'networkidle'});
 ...
 for(const [id,file] of [['pulse','pulse.nflyer']]){
   ...
   for(const format of ['square','story']){
     ...
     for(const objectId of ['headline','pulse','day','weekday','month','offer','details','rsvp','address','terms']){
