...
try{
 ...
 for(const [id,file] of [['i-love-thursday','i-love-thursday.nflyer']]){
   ...
   for(const format of ['square','story']){
     ...
     if(!process.env.NF_PREVIEW_ONLY)for(const objectId of ['weekday','month','day','ordinal','presenter','headline','thursday','city','offer','prices','host','address','contact','brand']){
