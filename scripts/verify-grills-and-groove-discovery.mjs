...
const out = process.env.NF_OUTPUT_DIR || '/tmp/grills-and-groove-discovery';
const eventName = process.env.NF_EVENT_NAME || 'Grills & Groove';
const theme = process.env.NF_THEME || 'Elegant';
const recipeId = process.env.NF_RECIPE_ID || 'grills-and-groove';
...
try {
  ...
  console.log('PASS Grills & Groove / Elegant through both personalized previews to the details form.');
} catch (error) {
