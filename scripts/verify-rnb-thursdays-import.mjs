...
try{
 ...
 for(const [id,file] of [['rnb-thursdays','rnb-thursdays.nflyer']]){
   ...
   for(const format of ['square','story']){
     ...
     if(!process.env.NF_PREVIEW_ONLY)for(const objectId of ["presenter", "headline", "thursdays", "month", "date", "time", "endTime", "attractions", "recurrence", "entry", "entryLabel", "address", "contactLabel", "contact"]){
