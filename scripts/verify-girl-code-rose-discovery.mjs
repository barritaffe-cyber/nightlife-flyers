...
const out = process.env.NF_OUTPUT_DIR || '/tmp/girl-code-rose-discovery';
const eventName = process.env.NF_EVENT_NAME || 'Girl Code';
const theme = process.env.NF_THEME || 'R&B / Lounge';
const recipeId = process.env.NF_RECIPE_ID || 'girl-code-rose';
