...
try{
 ...
 for(const [id,file] of [['amapiano-night','amapiano-night.nflyer']]){
   ...
   for(const format of ['square','story']){
     ...
     if(!process.env.NF_PREVIEW_ONLY)for(const objectId of ["presenter", "presents", "headline", "night", "date", "musicLabel", "lineup", "hostLabel", "hosts", "offerLabel", "offer", "venue", "address", "contactLabel", "contact"]){
