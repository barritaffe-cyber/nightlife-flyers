...
const plans: readonly Plan[] = [
  {
    ...
    tagline: 'Explore DJ / Promo and Creator Studio before turning on paid tools.',
    icon: Star,
    gradient:
    ...
    features: [
      ...
      'No uploads for backgrounds, portraits, logos, or custom graphics',
      'No AI tools, Extract Subject, project files, or clean exports',
    ],
    cta: 'Start Free',
  },
  {
